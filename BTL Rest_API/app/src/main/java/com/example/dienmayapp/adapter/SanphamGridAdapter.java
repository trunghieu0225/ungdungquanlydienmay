...
public class SanphamGridAdapter extends RecyclerView.Adapter<SanphamGridAdapter.ViewHolder> {

    private Context context;
    private ArrayList<Sanpham> list;

    public SanphamGridAdapter(Context context, ArrayList<Sanpham> list) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.activity_sanpham_grip, parent, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            imgAnh = itemView.findViewById(R.id.imgSanPhamGrip);
